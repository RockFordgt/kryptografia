...
Item {
    ...
    property alias color2:col2.color
    property alias paricles:particleSys.running

    Rectangle {
        anchors.fill: parent
        gradient: Gradient {
            GradientStop { id:col1; position: 0; color: "lightsteelblue" }
            GradientStop { id:col2; position: 1; color: "black" }
        }
    }
